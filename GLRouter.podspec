#
#  Be sure to run `pod spec lint GLKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/virtsun/GLRouter"
  ...
  s.source       = { :git => "git@github.com:virtsun/GLRouter.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "GLRouter", "GLRouter/**/*.{h,m}"
